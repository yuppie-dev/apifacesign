...
namespace Facesign.Services.Infra.Data.Migrations
{
    ...
    [Migration("20230110200834_CriarBD")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facesign.Services.Infra.Data.Data.Clients_Confs_FunctionalitiesData", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("Facesign.Services.Infra.Data.Data.Clients_Confs_LayoutsData", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("Facesign.Services.Infra.Data.Data.Clients_ConfsData", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("Facesign.Services.Infra.Data.Data.ClientsData", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("Facesign.Services.Infra.Data.Data.Clients_Confs_FunctionalitiesData", b =>
                {
                    b.HasOne("Facesign.Services.Infra.Data.Data.Clients_ConfsData", "conf")
                        .WithMany()
            ...
            modelBuilder.Entity("Facesign.Services.Infra.Data.Data.Clients_ConfsData", b =>
                {
                    b.HasOne("Facesign.Services.Infra.Data.Data.ClientsData", "client")
                        .WithMany()
